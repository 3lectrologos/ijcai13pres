...
\vspace{0.3em}
\item<15-> How do we \textbf{select} ``informative'' measurements? \uncover<22->{\Large\color{green!70!black}\checkmark}
\uncover<16->{
\begin{itemize}
...
\includegraphics<18>[width=3.7in]{figures/voned_cl_41_amb_0}
\includegraphics<19>[width=3.7in]{figures/voned_cl_41_amb_1}
\includegraphics<20->[width=3.7in]{figures/voned_cl_41_amb_2}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics<8->[width=2.5in]{figures/voned_cl_41_eps}
\end{center}
\end{columns}
\end{frame}
