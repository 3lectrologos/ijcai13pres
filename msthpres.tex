\documentclass[10pt,mathserif,serif]{beamer}
%\documentclass[10pt,mathserif,serif,draft, handout]{beamer}
...
\uncover<2->{\includegraphics[width=2.3in]{figures/ev_chl_seq}}
\uncover<3>{\includegraphics[width=2.3in]{figures/ev_chl_eps}}
\end{center}
\end{frame}
...
\only<5>{\includegraphics[width=4in]{figures/limno_bgape_class_354}}
\only<6>{\includegraphics[width=4in]{figures/limno_bgape_str_class_400}}
\only<7>{\includegraphics[width=4in]{figures/limno_bgape_var_class_400}}
\end{center}
\end{frame}
