...
\vspace{0.3em}
\item<15-> How do we \textbf{select} ``informative'' measurements? \uncover<16->{\Large\color{green!70!black}\checkmark}
\end{enumerate}
...
\includegraphics<13->[width=3.5in]{figures/voned_cl_41}
\end{center}
\end{frame}
